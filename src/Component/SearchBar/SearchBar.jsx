...
>>>>>>> c4394f02f75e013b352010af308dcb30c20ea43f
          ...
          <label
            htmlFor="bar"
            className={`labelFilter ${
              selectedOption === "bar" ? "selected" : ""
            }`}
          >
            <IonIcon className="icon-filter-search" icon={wine} />
            Bar
          </label>
          <input
            type="radio"
          ...
          <label
            htmlFor="restaurant"
            className={`labelFilter ${
              selectedOption === "restaurant" ? "selected" : ""
            }`}
          >
            <IonIcon className="icon-filter-search" icon={restaurant} />
            Restaurant
          </label>
          <input
            type="radio"
          ...
          {responseData.length > 0 ? (
            responseData.map((result) => (
              <div key={result.id} className="fiche">
                ...
                <p>
                  Propriétaire : {result.owner_lastname}{" "}
